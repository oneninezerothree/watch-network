<template>
  <div class="detail_footer">
    <div class="detail_footer_content">
      <li>
        <p
          class="clickService detail_footer_ico icon-a-ntalk-goods CUSTOMER-SERVICE iconfont"
          service-code="wx_1000_1515726307656"
        >&#xe673;</p>
        <p class="p2">客服</p>
      </li>
      ...
      <li class="detail_footer_cart js_cart">加入购物车</li>
    </div>
  </div>
</template>
<script lang="ts">
