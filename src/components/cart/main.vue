  ...
  <div>
    <div class="W-cart-head" id="W-cart-head">
      <div class="W_register h">
        <a
          href="javascript:;"
          style="background-image:url(//static.wbiao.co/p/m/images/1/download_tips_2.png);background-size: 100% auto;background-position: center center;"
          class="register"
        ></a>
      ...
      <div class="W-cart paddingTop80" id="W-cart">
        ...
        <div class="cart-content">
          <div class="shop-blocks editing" data-shop-code="7">
            <div class="goods">
              <div class="lines" v-for="(item,index) of goods" :key="index" ref="index">
                <div class="slide-wrap" style="touch-action: pan-y pinch-zoom;">
                  <div
                    class="slide-scroller clearfix"
                    style="transition-timing-function: cubic-bezier(0.1, 0.57, 0.1, 1); transition-duration: 0ms; transform: translate(0px, 0px) translateZ(0px);"
                  >
                    <div class="inner fl clearfix">
                      <a target="_self">
                        <div class="img fl">
                          <img :src="item.imgUrl">
                        </div>
                        <div class="desc" v-show="show">
                          ...
                          <p class="bottom clearfix">
                            <span class="price">
                              <i>¥</i>
                              <i class="wbiaoPrice">{{item.newprice}}</i>
                              <i>{{item.oldprice}}</i>
                            </span>
                            <span class="quatity fr">
                              x
                              <span>{{item.num}}</span>
                            </span>
                          </p>
                      ...
                      <div class="editor" v-if="!show">
                        <div class="calc clearfix">
                          <span class="minus calc-btns fl" @click="delNum(index,item.id)">-</span>
                          <div class="val">{{item.num}}</div>
                          <span class="plus calc-btns" @click="addNum(index,item.id)">+</span>
                        </div>
                        <button class="del" @click="moveGoods(item.id,index)">删除</button>
                      </div>
                    </div>
                    <span class="cart-tik">
                      <span
                        ...
                        @click="selectGoods(item.select,index)"
                      ></span>
                    ...
                    <div class="footer-bar footer-bar-normal">
                      <div class="left clearfix">
                        ...
                        <div class="detail fr">
                          <p>
                            总计:¥
                            <span id="payableAmount">{{sum}}</span>
                          </p>
                          <!-- <p>总额:¥<span id="goodsAmount">0</span></p> -->
                        </div>
                      </div>
                      <button class="submit-btn fr">结算</button>
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    getGoodsInfo() {
      axios
        .get(
          "https://www.easy-mock.com/mock/5cf5001e6e18ad42e9052ce1/example/watch-goods"
        )
